...
ThisBuild / description := "seichi915Network 椅子プラグイン"
...
lazy val root = (project in file("."))
  .settings(
    name := "seichi915Chairs",
    assemblyOutputPath in assembly := baseDirectory.value / "target" / "build" / s"seichi915Chairs-${version.value}.jar"
  )